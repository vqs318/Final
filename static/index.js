...
/***/ function(module, exports, __webpack_require__) {
	...
	var force = _d2.default.layout.force().charge(-120).linkDistance(30).size([dimensions.width, dimensions.height]);
	
	var svg = _d2.default.select("body").append("svg").attr("width", dimensions.width).attr("height", dimensions.height);
	...
	new _vue2.default({
	    ...
	    watch: {
	        ...
	        currentSubreddit: function currentSubreddit(sub) {
	            var _this2 = this;
	
	            _d2.default.json("/api/markov?s=" + sub + "?w=" + this.currentWord, function (error, json) {
	                _this2.tree = json;
	            });
	        },
	...
	function render(tree) {
	    force.nodes(tree.nodes).links(tree.links).start();
